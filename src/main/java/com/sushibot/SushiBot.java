...
public class SushiBot extends TelegramLongPollingBot {
    ...
    private void showPromotions(Long chatId) {
        String text = """
                ...
                • 🍣 **Скидка 20%** на все роллы по будням с 12:00 до 16:00
                • 🚗 **Бесплатная доставка** при заказе от 1000 рублей
                • 🎂 **День рождения?** Предъявите документ - получите торт в подарок!
                
                • 📱 **При заказе через бот** - дополнительная скидка 5%!
